...
export class AuthControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registerUserUsingPOST(signUpRequest: SignupRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public registerUserUsingPOST(signUpRequest: SignupRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public registerUserUsingPOST(signUpRequest: SignupRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public registerUserUsingPOST(signUpRequest: SignupRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (signUpRequest === null || signUpRequest === undefined) {
            throw new Error('Required parameter signUpRequest was null or undefined when calling registerUserUsingPOST.');
        }
        ...
        return this.httpClient.post<any>(`${this.basePath}/api/auth/signup`,
            signUpRequest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
